            ...
            <div class="bg-gray-50 py-12 md:py-24">
                <div class="mx-auto max-w-lg px-4 lg:px-8">
                    <div class="flex items-center">
                        <button name="deleteAll" type="submit" class="inline-flex items-center rounded border-2 border-red-500 bg-red-500 px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-transparent hover:text-red-500 focus:outline-none focus:ring active:opacity-75">
                            Empty Cart
