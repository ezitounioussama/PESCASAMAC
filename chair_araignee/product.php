          ...
          <form class="mt-8" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
            ...
            <div class="mt-8 flex">
              <div>
                ...
                <input type="number" name="qty" id="quantity" min="1" value="1" class="w-12 rounded border-gray-200 py-3 text-center text-xs [-moz-appearance:_textfield] [&::-webkit-outer-spin-button]:m-0 [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:m-0 [&::-webkit-inner-spin-button]:appearance-none" />
              </div>
