// LES MOULES DECORTOQUE

if ($("#id").html() == 33) {
  $(document).change(function () {
    if ($("#mycalibre option:selected").text() == "100/200g") {
      $("#trtm").html("");
...
if ($("#id").html() == 35) {
  $(document).change(function () {
    if (
      $("#mycalibre option:selected").text() == "Moyennes" &&
      $("#myselection option:selected").text() == "Pièces"
    ) {
      $("#trtm").html("");
      var inputVal1 = $("#p1").val();
      $("#prc").html(inputVal1);
      ...
      $("#mycalibre option:selected").text() == "Moyennes" &&
      $("#myselection option:selected").text() == "Paniers *50P"
    ) {
      $("#trtm").html("");
      ...
      $("#mycalibre option:selected").text() == "Petites" &&
      $("#myselection option:selected").text() == "Pièces"
    ) {
      $("#trtm").html("");
      var inputVal1 = $("#p1").val();
...
if ($("#id").html() == 37) {
  $(document).change(function () {
    if ($("#mycalibre option:selected").text() == "5Kg") {
      $("#trtm").html("");
      var inputVal1 = $("#p1").val();
      $("#prc").html(inputVal1);
      $("#product_price").val(inputVal1);
...
if ($("#id").html() == 38) {
  $(document).change(function () {
    if ($("#mycalibre option:selected").text() == "carton 10 Kg") {
      $("#trtm").html("");
      var inputVal1 = $("#p1").val();
      $("#prc").html(inputVal1);
      $("#product_price").val(inputVal1);
